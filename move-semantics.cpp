/*
    ...
    - std::move will convert lvalue to rvalue reference instead of casting
*/
...
int main()
{
    ...
    printObjRvalueReference(Obj("Message...")); // Takes in rvalue and is more efficient than copying
